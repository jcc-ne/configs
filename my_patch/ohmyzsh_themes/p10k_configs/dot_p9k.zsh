# Generated by Powerlevel10k configuration wizard on 2019-12-15 at 10:53 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=145
  ...
  typeset -g POWERLEVEL9K_DISABLE_HOT_RELOAD=true
    ...
    # -- legacy powerlevel9k setup
  typeset -g POWERLEVEL9K_MODE='nerdfont-complete'
  typeset -g POWERLEVEL9K_CUSTOM_MYPROMPT="echo ♛"
   typeset -g  POWERLEVEL9K_CUSTOM_MYPROMPT_BACKGROUND="008"
 typeset -g    POWERLEVEL9K_CUSTOM_MYPROMPT_FOREGROUND="174"
 typeset -g    POWERLEVEL9K_TIME_BACKGROUND="008"
    if [ $HOST = "MSI65" ];then
 typeset -g        POWERLEVEL9K_TIME_FOREGROUND="black"
    else
 typeset -g        POWERLEVEL9K_TIME_FOREGROUND="174"
    fi
 typeset -g    POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon background_jobs dir vcs newline time host)
 typeset -g    POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(disk_usage load ram command_execution_time )
 typeset -g    POWERLEVEL9K_RAM_BACKGROUND="cyan"
 typeset -g    POWERLEVEL9K_PROMPT_ADD_NEWLINE=true
 typeset -g    POWERLEVEL9K_SHORTEN_DIR_LENGTH=4
 typeset -g    POWERLEVEL9K_SHORTEN_MIN_LENGTH=12
